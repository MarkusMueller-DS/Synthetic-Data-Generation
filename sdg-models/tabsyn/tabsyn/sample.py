...
def main(args):
    ...
    if args.ci != None:
        save_path_folder = f"../../data/synthetic/{dataname}-{args.ci}"
    else:
        save_path_folder = f"../../data/synthetic/{dataname}"
    ...
    if args.dataname == "cc-fraud":
        if args.ci == "1":
            num_samples = 77224  # for 1% class imbalance
        if args.ci == "5":
            num_samples = 14184  # for 5% class imblance
