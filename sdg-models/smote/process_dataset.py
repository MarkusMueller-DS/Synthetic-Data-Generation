...
train_df.to_csv("data/processed/adult/train.csv", index=False)
train_df_src.to_csv("data/processed/adult/train_src.csv", index=False)
test_df.to_csv("data/processed/adult/test.csv", index=False)
