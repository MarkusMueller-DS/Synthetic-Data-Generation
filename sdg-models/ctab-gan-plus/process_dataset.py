...
# tranform categorical columns to labels
#for col_idx in cat_col_idx_list:
#    encoder = LabelEncoder()
#    train_df[col_idx] = encoder.fit_transform(train_df[col_idx])
#    test_df[col_idx] = encoder.transform(train_df[col_idx])
...
train_df.to_csv("Real_Datasets/test.csv", index=False)