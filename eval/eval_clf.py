...
def sdg_run():
    ...
    df_train[target_col_name] = df_train[target_col_name].map({info["maj_class"]:0, info["min_class"]: 1}) 
    df_test[target_col_name] = df_test[target_col_name].map({info["maj_class"]:0, info["min_class"]: 1}) 
